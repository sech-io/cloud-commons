package com.github.sech.commons.redis.service;
...
public interface RedisService {
     ...
     *
     * @param key the key
     * @param map the map map中的Object对象都会转为JSON存储
     */
     ...
     * @param key    缓存hash key
     * @param fields 缓存hash fields
